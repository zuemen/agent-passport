...
mandate is revoked, and no authorized intent is accepted twice), 2 fork tests against the official ERC-8004 Identity Registry on Monad testnet, 18 SDK tests
